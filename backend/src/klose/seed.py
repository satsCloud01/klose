...
async def seed_database():
    async with async_session() as session:
        ...
        leads = [
            ...
            Lead(id=15, name="Omar Hassan", phone="+971-4-555-0015", email="ohassan@email.com", source="Walk-in", status="qualified", intent_score=70, budget_min=6000000, budget_max=8000000, preferred_bhk="4 BHK", preferred_location="Dubai Marina", assigned_to=1),
        ...
        # ── Properties (15) ──
        props = [
            Property(id=1, name="The Azure Residence", developer="Emaar Properties", location="Palm Jumeirah, Dubai", type="Villa", bhk="3, 4 & 5 BHK", price_min=4200000, price_max=6800000, carpet_area=6400, rera_number="DXB-RE-2024-001", rera_verified=True, status="available", construction_status="ready", image_url="https://lh3.googleusercontent.com/aida-public/AB6AXuDjRkoR0C6nb1LEQhF4smFI5_kNT3SgTif2O4_Bh7rfJZ7nm9o0LVuDhNcW57lTbysKBolngM-kG9mP23UlIkrPiDLUMbfNHnswYX3JS3hZBshCeUg1syQyGbnJLFlPhlX4MDEwPY8nHM3PhbrfhtDd-kK6ymsIkQOFHlCUfaxsyWxvuIOD1A5hFsDk3mg22nwNyTFlIjbDwRLCvluW4zL1uhE--OHpP3IoU8z045DbSkuKj_49MUwEoOI2oxXOkLnE0TlE6I3JgU0", description="Ultra-luxury waterfront villa with private beach access."),
            Property(id=2, name="Oasis Pavilion", developer="Sobha Realty", location="Arabian Ranches, Dubai", type="Villa", bhk="4 BHK", price_min=2800000, price_max=3500000, carpet_area=4200, rera_number="DXB-RE-2024-002", rera_verified=True, status="available", construction_status="under_construction", image_url="https://lh3.googleusercontent.com/aida-public/AB6AXuCwka4lp9wdQSI9GHac6N5bsM48hrKsR7uy8reMghItXOo7ZWELn7s85gbIkKeSzMZx39T_g8ns0KU4uwy4yhOtRUjvvAAmpuv2xxuUkMqls299q715Flfbnm3---gNEZyDgvxaOBBsOAIVVSi3o9-oMPcdSj4TjGUsNqg65ToNQZqW-etlmwZmmSFeRdGP5l4w9AHkRF6w8OKbqGSGwyejf6a5U6DyvZ3Qmbcy7IwpbqPKTj_cQ4GIFpozNFfTmvgtJES2TFc_16Q", description="Contemporary desert oasis with private garden pavilion."),
            Property(id=3, name="Skyline Heights", developer="Damac", location="Downtown District, Dubai", type="Apartment", bhk="2 & 3 BHK", price_min=1200000, price_max=2400000, carpet_area=1800, rera_number="DXB-RE-2024-003", rera_verified=False, status="available", construction_status="ready", image_url="https://lh3.googleusercontent.com/aida-public/AB6AXuBek4ZBR9QBlokSByl976pLFMnnI19uOw6xczGsgAe6xtDldvDvw0yBKv5UpJogWMMuXnGWqo8qKn3Uk_7F3ak7o5FR6gDXk_W-1oLBMc-xboDCQeRtWznizSPMru15lpsreSkTgpE1KTrRfu2YLeK0jw7vSBLYsd_oL_KpVQA8XUqX26BN4Y6pkBDMyubWdnJO4igAfNyoWqP3sfXqiWbvKRZMusWQ1dSn322HpGfd4XWnruJE8PwgV0zib93OpgTBKNXcfUaWMxI", description="Panoramic skyline views from every unit."),
            Property(id=4, name="The Grand Estate", developer="Meraas", location="Emirates Hills, Dubai", type="Villa", bhk="6+ BHK", price_min=12000000, price_max=18000000, carpet_area=12000, rera_number="DXB-RE-2024-004", rera_verified=True, status="available", construction_status="ready", image_url="https://lh3.googleusercontent.com/aida-public/AB6AXuDD0RUt17vCKVk_n_v-DaB3JSdRCaPr28s63I9GDBCo4NemR91FCylDsoPvdoi4G-dR8fwgNYtS4tS1k64X19nDqpb7anhsf9uv_tKsl9lUlvaeP6NkpjT3EUijMbAwLIPNBM5iTPFWzumcR1V4FvcKaDyxTIYdIB9IpVTr8MEB7dICX0JHo7hmczr7pDCsVxe7uoft9G8QkfxN3qfIzh0q1BL0OndtwScmY0QU6NvBsH8iqI55H-zuT9u7d8PVTnKc2_KNHt2SZ5g", description="Palatial estate with landscaped grounds and private lake."),
            Property(id=5, name="Verdant Meadows", developer="Nakheel", location="Meydan, Dubai", type="Plot", bhk="N/A", price_min=850000, price_max=1200000, carpet_area=8000, rera_number="", rera_verified=False, status="available", construction_status="ready", image_url="https://lh3.googleusercontent.com/aida-public/AB6AXuAiY7qmyoy2MeI8WRR7EwZciq5KZvIIghE5FCt4Ei_A5I4q-NG4pSdwDrju9lWYyAj1BlLaHbZNdJSlCcHUyfvJvMIPy1xKwKLQ4OREc8iE_Vpi4znZd7ghjvevMqXsDfnp_2--fszEixb4ZhKO8oeNEM82j5JjChwle5HhDxNXuPgdIIm3CAyArUhsLuxDKuiKFYesZPzxpxNq2Okml-cCAOZfqNSIRuuqDEbAMPh7SYmf1QzbC3ukzXpZN4YUualev44rIImJzD0", description="Premium residential plot in a gated community."),
            Property(id=6, name="Mariner's Quay", developer="Select Group", location="Dubai Marina", type="Apartment", bhk="1 & 2 BHK", price_min=900000, price_max=1500000, carpet_area=1200, rera_number="DXB-RE-2024-006", rera_verified=False, status="available", construction_status="under_construction", image_url="https://lh3.googleusercontent.com/aida-public/AB6AXuDyunNyoml7NRFpYRHcPo9EvhKoKh0zmFSwy0UHLImZdHUHnRUsFY4admTAS5LkhUJ_2YzqnqEUQ2Tn0Ia038oCcqPkECRlVisHTTLumVJKdS8AyhN6nBk7HS58iiFbgCU8ZSHtwmt68sbyt_IWlfEkk4D6tuLuOtu2tMcZ1snp59C_Uu1hnqsS3I8eEBaWl_GIXyUP8xgnvZp0KPPhJ7hX9J6eR3xpu7bLeyql2PtCDLjmC2-ObRPOrwWz0eScpgb22x0hMZNZq3c", description="Waterfront living with marina yacht berth."),
            Property(id=7, name="Azure Heights Penthouse", developer="Omniyat", location="Dubai Marina", type="Penthouse", bhk="5 BHK", price_min=12500000, price_max=12500000, carpet_area=6400, rera_number="DXB-RE-2024-007", rera_verified=True, status="available", construction_status="ready", image_url="https://lh3.googleusercontent.com/aida-public/AB6AXuDvcL0YBWIS-VUuQ9X_RCpQp5cFWnIDPma2bFRbxXDTBwUX1fQdVKO8h4xA0siB9fXYR7yjt-1P24QRjzCvRIeIj-AmaYZVjyPkAvanWHXN1oL53jLa86tSG1zlJJaLyD1i9xgzDR5Qrri-KcXkG9hkhjNjCAY0u5FLiqloXH26jouAivyNB8F9JltPLGqjT3MeQhUhDUfkotlj1u_bFcYMFrVLizU-LdbSqNCNL2cU7gTi8t7FpSJyoU7a0SVNSm6BacIWgUTMbiY", description="Ultra-premium penthouse with 360° views."),
            Property(id=8, name="The Obsidian Estate", developer="Al Habtoor", location="Emirates Hills, Dubai", type="Villa", bhk="4 BHK", price_min=8200000, price_max=8200000, carpet_area=5500, rera_number="DXB-RE-2024-008", rera_verified=True, status="available", construction_status="ready", image_url="https://lh3.googleusercontent.com/aida-public/AB6AXuDS7qMcWQP_WKRruqUIhqhzaHkE2P8kOJaVj2KqyC00YoPk2vTz-Z7zu0_9FwXEPxhADJnVK_0YojlCzIKL8VpwrkrdI2he9Pxify7neo9lpE5H0bFPiPuMoXxscWx1K-DyAusP0BPw9TFEE0IzdlRSa9pcczQbsgmuYhKsszV5mKwsgZKIbegQUt59P_JawWaNH-r9AnV3QtU-TmHigqcRHHZrYgUAuVN5F-uf_M_BleTkLmjyZvHUBEq5E9CvZ-N-3oA8sld8CH0", description="Modern estate with infinity pool and cinema room."),
            Property(id=9, name="Sky Garden Penthouse", developer="Emaar", location="Downtown Dubai", type="Penthouse", bhk="4 BHK", price_min=9000000, price_max=11000000, carpet_area=5000, rera_number="DXB-RE-2024-009", rera_verified=True, status="reserved", construction_status="ready", image_url="", description="Rooftop garden penthouse with Burj Khalifa views."),
            Property(id=10, name="The Glass Pavilion", developer="Nakheel", location="Bel Air, LA", type="Villa", bhk="5 BHK", price_min=14500000, price_max=14500000, carpet_area=8500, rera_number="", rera_verified=False, status="available", construction_status="ready", image_url="https://lh3.googleusercontent.com/aida-public/AB6AXuC7dPbWFRLKNmTUMjOzIpx82GylyvZ6h9NPdkf5ipiSgESBGTPzV8XLz0UEe4oyrsN6cZm5dBQC8ACDhf1PbGPeLLJ4ZFkQR_lysXO1GWdPBCOx8tG1LM5vwOCuedIULCai7EfezCPgq0vqi-t-HNBSlrE3jqRdVckDaYhvwBjmjgGkmMqczP_Xs5SZxPaQMLeub5QXkQXcf6FBRyR_0i0hiqvoJf5Ms3WBQmI7u2VKq-4vNKfwLjQTmKWP1feq4kyPH2Kj96MhWVI", description="Architectural masterpiece with panoramic canyon views."),
            Property(id=11, name="Belvedere Heights", developer="Lodha Group", location="Belvedere District", type="Apartment", bhk="3 & 4 BHK", price_min=4200000, price_max=4800000, carpet_area=3200, rera_number="BH-2024-011", rera_verified=True, status="available", construction_status="ready", image_url="", description="Premium residences in the heart of Belvedere."),
            ...
            Property(id=14, name="Royal Plaza", developer="K Raheja", location="BKC, Mumbai", type="Penthouse", bhk="6+ BHK", price_min=12500000, price_max=12500000, carpet_area=8000, rera_number="MH-RE-2024-014", rera_verified=True, status="reserved", construction_status="ready", image_url="", description="Ultra-luxury penthouse atop India's tallest residential tower."),
            Property(id=15, name="4200 Skyline Dr.", developer="Private", location="Belvedere Heights", type="Villa", bhk="5 BHK", price_min=4450000, price_max=4450000, carpet_area=4200, rera_number="", rera_verified=False, status="available", construction_status="ready", image_url="https://lh3.googleusercontent.com/aida-public/AB6AXuD1LkMtmNwf8juYL0nJkU1T2sLrH_9PomigHNWhutujKqk8JGuDc1973zxHvCHPpP8Zk9xtvvpSpUrLXN67cf6Tcp61TOYdYv-DNwWCXvvwNPLR-0lLvkmOCLKtgq5JMb4T5XJUsFCvm6rpFI2iWSTooH64dS9SCS3uYjK64u_2U8Njc_s7xrmFisowN-I9i8fKAyuOukrW-7uByeB3C-NT10rZ_hXsvkRr-VRGjjhWoJd8RP0-kHf91udo_biZ3Xicf5E312NeFqA", description="Subject property for active negotiation."),
        ]
        ...
        commissions = [
            ...
            Commission(id=6, partner_id=6, ref_number="LF-8520", description="Marina Villa - Gulf", amount=8400, status="paid", paid_at=now - timedelta(days=2), created_at=now - timedelta(days=8)),
